...
public class FileOrderingTest {
  ...
  public void filenameOrdering() throws FileOrdering.CriteriaException {
    ...
    final Iterable< File > sortedFiles = new FileOrdering.ByAbsolutePath( unsortedFiles ).sort() ;
  ...
  public void versionOrdering() throws FileOrdering.CriteriaException {
    ...
    final Iterable< File > sortedFiles = new FileOrdering.ByVersionNumber( unsortedFiles ).sort() ;
  ...
  public void badVersionFormat() {
    ...
    try {
      new FileOrdering.ByVersionNumber( unsortedFiles ) ;
