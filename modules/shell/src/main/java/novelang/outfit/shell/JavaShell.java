...
import novelang.outfit.shell.insider.Insider;

import static com.google.common.base.Preconditions.checkArgument;
import static com.google.common.base.Preconditions.checkNotNull;

/**
 * Starts and shuts down a JVM with an {@link novelang.outfit.shell.insider.InsiderAgent}
 ...
 *     {@link novelang.outfit.shell.insider.Insider#shutdown()} that attempts to perform
 ...
 *     {@link novelang.outfit.shell.insider.Insider#keepAlive()} wasn't called for a few seconds.
...
public class JavaShell extends ProcessShell {
  ...
  private static final Predicate< String > LOCAL_INSIDER_STARTED = new Predicate< String >() {
    ...
    public boolean apply( final String input ) {
      ...
      return input.contains( "Loaded novelang.outfit.shell.insider.InsiderAgent." ) ;
    }
  } ;
