...
import novelang.testing.RepeatedAssert;
import novelang.testing.StandalonePredicate;
...
// =======
  ...
  private static class ShellFixture {
    ...
    public ShellFixture() throws IOException {
      final int jmxPort = novelang.outfit.TcpPortBooker.THIS.find() ;
      dummyListenerPort = novelang.outfit.TcpPortBooker.THIS.find() ;
      ...
      parameters = novelang.outfit.Husk.create( JavaShellParameters.class )
          .withNickname( "Stupid" )
          .withWorkingDirectory( scratchDirectory )
          .withJavaClasses( new JavaClasses.ClasspathAndMain(
              "novelang.outfit.shell.StupidListener",
              jarFile
          ) )
