...
public class Spaces {
  ...
  static {
    ...
    add( BLOCK_INSIDE_SOLIDUS_PAIRS, BLOCK_AFTER_TILDE ) ;
    ...
    add( BLOCK_OF_LITERAL_INSIDE_GRAVE_ACCENTS, BLOCK_AFTER_TILDE ) ;
    ...
    add( BLOCK_OF_LITERAL_INSIDE_GRAVE_ACCENT_PAIRS, BLOCK_AFTER_TILDE ) ;
    add( BLOCK_OF_LITERAL_INSIDE_GRAVE_ACCENT_PAIRS, WORD_ ) ;
    add( BLOCK_INSIDE_HYPHEN_PAIRS, WORD_ ) ;
    add( BLOCK_INSIDE_HYPHEN_PAIRS, BLOCK_AFTER_TILDE ) ;
    ...
    add( BLOCK_INSIDE_PARENTHESIS, BLOCK_AFTER_TILDE ) ;
    ...
    add( PUNCTUATION_SIGN, BLOCK_AFTER_TILDE ) ;
    ...
    add( BLOCK_INSIDE_DOUBLE_QUOTES, BLOCK_AFTER_TILDE ) ;
    ...
    add( BLOCK_INSIDE_SQUARE_BRACKETS, BLOCK_AFTER_TILDE ) ;
    add( BLOCK_OF_LITERAL_INSIDE_GRAVE_ACCENTS, BLOCK_INSIDE_PARENTHESIS ) ;
    add( BLOCK_OF_LITERAL_INSIDE_GRAVE_ACCENTS, WORD_ ) ;
    add( BLOCK_OF_LITERAL_INSIDE_GRAVE_ACCENTS, BLOCK_AFTER_TILDE ) ;
    ...
    add( WORD_AFTER_CIRCUMFLEX_ACCENT, BLOCK_AFTER_TILDE ) ;
    add( WORD_AFTER_CIRCUMFLEX_ACCENT, WORD_ ) ;

    add( BLOCK_AFTER_TILDE, BLOCK_INSIDE_SOLIDUS_PAIRS ) ;
    add( BLOCK_AFTER_TILDE, BLOCK_OF_LITERAL_INSIDE_GRAVE_ACCENT_PAIRS ) ;
    add( BLOCK_AFTER_TILDE, BLOCK_INSIDE_HYPHEN_PAIRS ) ;
    add( BLOCK_AFTER_TILDE, BLOCK_INSIDE_TWO_HYPHENS_THEN_HYPHEN_LOW_LINE ) ;
    add( BLOCK_AFTER_TILDE, BLOCK_INSIDE_PARENTHESIS ) ;
    add( BLOCK_AFTER_TILDE, BLOCK_INSIDE_DOUBLE_QUOTES ) ;
    add( BLOCK_AFTER_TILDE, BLOCK_OF_LITERAL_INSIDE_GRAVE_ACCENTS ) ;
    add( BLOCK_AFTER_TILDE, BLOCK_INSIDE_SQUARE_BRACKETS ) ;
    add( BLOCK_AFTER_TILDE, BLOCK_AFTER_TILDE ) ;
    add( BLOCK_AFTER_TILDE, WORD_ ) ;
