...
/**
 * Starts and stops an {@link org.novelang.produce.DocumentProducer} in its deployment directory,
 * in a separate JVM.
 *
  ...
  )
  {
    return configuration
        .withProgramOtherOptions(
            "--" + org.novelang.configuration.parse.BatchParameters.OPTIONNAME_OUTPUTDIRECTORY,
