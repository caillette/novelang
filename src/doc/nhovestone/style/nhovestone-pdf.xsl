...
>
  ...
  <xsl:template match="n:block-inside-square-brackets[text()='JVMCHARACTERISTICS']" >
    <fo:table>
      ...
      <fo:table-column column-width="proportional-column-width(1)" />
      <fo:table-body>
        <xsl:for-each select="/n:book/n:level[ n:level-title='JVMCHARACTERISTICS' ]/n:cell-rows-with-vertical-line/n:cell-row" >
  ...
  <xsl:template match="n:block-inside-square-brackets[text()='NHOVESTONEPARAMETERS']" >
    <fo:table>
      ...
      <fo:table-column column-width="proportional-column-width(1)" />
      <fo:table-body>
        <xsl:for-each select="/n:book/n:level[ n:level-title='NHOVESTONEPARAMETERS' ]/n:cell-rows-with-vertical-line/n:cell-row" >
          <xsl:call-template name="table-row" >
            <xsl:with-param name="cell1" select="n:cell[ 1 ]" />
            <xsl:with-param name="cell2" select="n:cell[ 2 ]" />
          </xsl:call-template>
