...
/**
 * Installs the jar of the {@link novelang.outfit.shell.insider.InsiderAgent} somewhere
...
public class AgentFileInstaller {
  ...
  public static final String AGENTJARFILE_SYSTEMPROPERTYNAME =
      "novelang.outfit.shell.agentjarfile" ;
  ...
  public static final String VERSIONOVERRIDE_SYSTEMPROPERTYNAME =
      "novelang.outfit.shell.versionoverride" ;
   ...
   * {@link novelang.outfit.shell.insider.InsiderAgent}.
   *
  ...
  private static final String JAR_RESOURCE_NAME_RADIX =
      "/novelang/outfit/shell/Novelang-insider-" ;
  ...
  private static final String VERSION_RESOURCE_NAME=
      "/novelang/outfit/shell/version.txt" ;
