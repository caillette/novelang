...
public class MeasurementBundle< MEASUREMENT > implements Iterable< MEASUREMENT > {
  ...
  public boolean equals( final Object o ) {
    ...
    final MeasurementBundle that = ( MeasurementBundle ) o ;

    if( !measurementList.equals( that.measurementList ) ) {
      return false;
    }
  ...
  @Override
  public int hashCode() {
    int result = measurementList.hashCode();
    result = 31 * result + ( termination != null ? termination.hashCode() : 0 );
    return result;
  }
}
