 ...
 * property. The {@link ProcessShell#start(long, java.util.concurrent.TimeUnit)} method should
 * take care of this.
 *
...

{
  ...
  public static final String SHUTDOWN_TATTOO_PROPERTYNAME = "novelang.outfit.shell.tattoo" ;
